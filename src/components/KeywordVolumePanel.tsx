...
const sourceInfo: Record<KeywordVolumeSource, { label: string; caption: string; icon: typeof BarChart3 }> = {
  ...
  keyword_surfer: { label: "Keyword Surfer", caption: "Автосбор через Chromium · CSV как резерв", icon: CircleGauge },
};
